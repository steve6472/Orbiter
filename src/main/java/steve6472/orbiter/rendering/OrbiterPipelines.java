...
public interface OrbiterPipelines
{
    ...
    PipelineConstructor SKIN = (device, extent, renderPass, setLayouts) -> PipelineBuilder
        .create(device)
        .shaders()
            .addShader(ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER, "orbiter/shaders/skin.vert", VK_SHADER_STAGE_VERTEX_BIT)
            .addShader(ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER, "orbiter/shaders/skin.frag", VK_SHADER_STAGE_FRAGMENT_BIT)
            .done()
