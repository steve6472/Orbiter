...
public class Orlang
{
    ...
    static
    {
        ...
        MATH_FUNCTIONS.put("sin", OrlangValue.func(D, Math::sin));
        MATH_FUNCTIONS.put("cos", OrlangValue.func(D, Math::cos));
        MATH_FUNCTIONS.put("asin", OrlangValue.func(D, Math::asin));
        MATH_FUNCTIONS.put("acos", OrlangValue.func(D, Math::acos));
        MATH_FUNCTIONS.put("atan", OrlangValue.func(D, Math::atan));
        MATH_FUNCTIONS.put("atan2", OrlangValue.func(D, D, Math::atan2));
