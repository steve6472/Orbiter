 ...
 * Project: Orbiter <br>
 */
public record UpdateEntityComponents(UUID uuid, int componentCount, ByteBuf buffer) implements Packet<UpdateEntityComponents, GameListener>
{
    public static final Key KEY = Key.defaultNamespace("update_entity_components");
    public static final BufferCodec<ByteBuf, UpdateEntityComponents> BUFFER_CODEC = BufferCodec.of(
        ...
        BufferCodecs.INT, UpdateEntityComponents::componentCount,
        ExtraBufferCodecs.BUFFER, UpdateEntityComponents::buffer,
